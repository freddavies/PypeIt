...
``outdir``                 str              ..       ``/home/xavier/Projects/PypeIt-Codes/PypeIt/doc``  The path where all coadded output files and report files will be placed.                                                                                                                                                                                                                                                                                                                                          
...
``redux_path``          str             ..       ``/home/xavier/Projects/PypeIt-Codes/PypeIt/doc``  Path to folder for performing reductions.  Default is the current working directory.                                                                                                                                                                                                                                                                                                                      
